...
/* ISR */
#define pISR_RESET	(*(unsigned *)(_IRQ_BASEADDRESS+0x40))
#define pISR_UNDEF	(*(unsigned *)(_IRQ_BASEADDRESS+0x44))
#define pISR_SWI	(*(unsigned *)(_IRQ_BASEADDRESS+0x48))
#define pISR_PABORT	(*(unsigned *)(_IRQ_BASEADDRESS+0x4c))
#define pISR_DABORT	(*(unsigned *)(_IRQ_BASEADDRESS+0x50))
#define pISR_RESERVED	(*(unsigned *)(_IRQ_BASEADDRESS+0x54))
#define pISR_IRQ	(*(unsigned *)(_IRQ_BASEADDRESS+0x58))
#define pISR_FIQ	(*(unsigned *)(_IRQ_BASEADDRESS+0x5c))

...
void CPlotCenterApp::ReadIniFile()
{
	...
	m_dPaperWidth=atof(GetProfileString(_T("Para"), _T("PaperWidth"), "1200"));
	m_dPaperLength=atof(GetProfileString(_T("Para"), _T("PaperLength"), "1500"));
	...
	m_dGraphWidth=atof(GetProfileString(_T("Para"), _T("GraphWidth"), "1200"));
	CString str;
	...
	gl_dPaperLength = m_dPaperLength;	//20140709 纸张长度

	//gzr20160906读取字体 start
	theApp.m_config.m_lfDrawText.lfCharSet = GetProfileInt(_T("Para"),_T("lfCharSet"),0);
	theApp.m_config.m_lfDrawText.lfClipPrecision = GetProfileInt(_T("Para"),_T("lfClipPrecision"),0);
	theApp.m_config.m_lfDrawText.lfItalic = GetProfileInt(_T("Para"),_T("lfItalic"),0);
	theApp.m_config.m_lfDrawText.lfOutPrecision = GetProfileInt(_T("Para"),_T("lfOutPrecision"),0);
	theApp.m_config.m_lfDrawText.lfPitchAndFamily = GetProfileInt(_T("Para"),_T("lfPitchAndFamily"),0);
	theApp.m_config.m_lfDrawText.lfQuality = GetProfileInt(_T("Para"),_T("lfQuality"),0);
	theApp.m_config.m_lfDrawText.lfStrikeOut = GetProfileInt(_T("Para"),_T("lfStrikeOut"),0);
	theApp.m_config.m_lfDrawText.lfUnderline = GetProfileInt(_T("Para"),_T("lfUnderline"),0);
	
	theApp.m_config.m_lfDrawText.lfEscapement = atol(GetProfileString(_T("Para"), _T("lfEscapement"), "0"));
	theApp.m_config.m_lfDrawText.lfHeight = atol(GetProfileString(_T("Para"), _T("lfHeight"), "0"));
	theApp.m_config.m_lfDrawText.lfWidth = atol(GetProfileString(_T("Para"), _T("lfWidth"), "0"));
	theApp.m_config.m_lfDrawText.lfOrientation = atol(GetProfileString(_T("Para"), _T("lfOrientation"), "0"));
	theApp.m_config.m_lfDrawText.lfWeight = atol(GetProfileString(_T("Para"), _T("lfWeight"), "0"));
	
	str=GetProfileString(_T("Para"), _T("lfFaceName"), "HP Roman 8");
	strcpy(theApp.m_config.m_lfDrawText.lfFaceName,str);
	//gzr20160906读取字体 end
}
...
void CPlotCenterApp::WriteIniFile()
{
	...
	str.Format("%f",m_dPaperLength);
	WriteProfileString(_T("Para"), _T("PaperLength"),str);
	...
	//gzr20160906保存字体 start
	WriteProfileInt(_T("Para"),_T("lfCharSet"),(int)theApp.m_config.m_lfDrawText.lfCharSet);
	WriteProfileInt(_T("Para"),_T("lfClipPrecision"),(int)theApp.m_config.m_lfDrawText.lfClipPrecision);
	
	str.Format("%ld",theApp.m_config.m_lfDrawText.lfEscapement);
	WriteProfileString(_T("Para"),_T("lfEscapement"),str);
	WriteProfileString(_T("Para"),_T("lfFaceName"),theApp.m_config.m_lfDrawText.lfFaceName);
	
	str.Format("%ld",theApp.m_config.m_lfDrawText.lfHeight);
	WriteProfileString(_T("Para"),_T("lfHeight"),str);
	
	WriteProfileInt(_T("Para"),_T("lfItalic"),(int)theApp.m_config.m_lfDrawText.lfItalic);
	
	str.Format("%ld",theApp.m_config.m_lfDrawText.lfOrientation);
	WriteProfileString(_T("Para"),_T("lfOrientation"),str);
	
	WriteProfileInt(_T("Para"),_T("lfOutPrecision"),(int)theApp.m_config.m_lfDrawText.lfOutPrecision);
	WriteProfileInt(_T("Para"),_T("lfPitchAndFamily"),(int)theApp.m_config.m_lfDrawText.lfPitchAndFamily);
	WriteProfileInt(_T("Para"),_T("lfQuality"),(int)theApp.m_config.m_lfDrawText.lfQuality);
	WriteProfileInt(_T("Para"),_T("lfStrikeOut"),(int)theApp.m_config.m_lfDrawText.lfStrikeOut);
	WriteProfileInt(_T("Para"),_T("lfUnderline"),(int)theApp.m_config.m_lfDrawText.lfUnderline);
	
	str.Format("%ld",theApp.m_config.m_lfDrawText.lfWeight);
	WriteProfileString(_T("Para"),_T("lfWeight"),str);
	str.Format("%ld",theApp.m_config.m_lfDrawText.lfWidth);
	WriteProfileString(_T("Para"),_T("lfWidth"),str);
	//gzr20160906保存字体 end
}

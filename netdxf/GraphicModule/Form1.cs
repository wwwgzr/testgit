...
namespace GraphicModule
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //    myProcess.StartInfo.FileName = @"C:\Program Files (x86)\Soft Gold\ABViewer 9\ABViewer.exe";
            ...
            //}  
            ToBit(sbyte.MaxValue);
            string Str_Value = Convert.ToString(2, 2);
            Console.WriteLine(Str_Value);
        }

        public static void ToBit(SByte s)
        {
            String str = "hoge-中";
            ...
            {
                string Str_Value = Convert.ToString(arr[i], 2);
                Console.WriteLine(Str_Value);
            }
        }
        ...
        private void Form1_KeyUp(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.A:
                    ...
                    {
                        dxfDoc = DxfDocument.Load(this.openFileDialog1.FileName);
                        GetGraphicFromDXF();

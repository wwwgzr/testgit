...
                        if (Int32.Parse(tempStr) > 255)                         { 
                            MessageBox.Show(tempStr + " 不是一个有效项目。请指定一个介于 1 和 223 之间的数值。"); 
                            textBox.Text = "255";                             textBox.Focus();                             return;                         } 
                        this.textBox4.Focus();                         this.textBox4.SelectAll();                     } 
...
                this.textBox1.Text = "223";                 this.textBox1.Focus();             } 
...
                this.textBox2.Text = "255";                 this.textBox2.Focus();             } 
...
                this.textBox3.Text = "255";                 this.textBox3.Focus();             } 
            OnResize(this, new EventArgs());         } 
...
                this.textBox4.Text = "255";                 this.textBox4.Focus();             } 
            OnResize(this, new EventArgs());         } 

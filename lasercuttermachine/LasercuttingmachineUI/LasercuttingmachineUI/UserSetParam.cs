...
{
    public partial class UserSetParam : UserControl
    {
        ...
        private void SaveConfig()
        {
            ...
            if (isSuccess)
            {
                ...
                if (addCutFileForm != null && addCutFileForm.file != null)
                {
                    ...
                    ParseCommunicationCommand.SaveConfig(addCutFileForm.file.cutFileName);
                }
                else
                {
            ...
            {
                InitialControl(ParseCommunicationCommand.readParam);

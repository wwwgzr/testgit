...
namespace LasercuttingmachineUI
{
    ...
    {
        private int level;
        Bitmap bitmap1 = new Bitmap(Application.StartupPath + "\\icon\\图标-01.png");
        Bitmap bitmap2 = new Bitmap(Application.StartupPath + "\\icon\\sss.png");
        ...
        public MenuButton AddButton1(string name, string text, object tag,bool visible = true)
        {
            ...
            //mbtn_test.BackColor = this.BackColor;

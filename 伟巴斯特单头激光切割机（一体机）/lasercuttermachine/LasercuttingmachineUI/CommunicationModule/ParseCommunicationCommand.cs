...
namespace CommunicationModule
{
    public class ParseCommunicationCommand
    {
        ...
        public static short feedOffset = 300;
        public static short sectionLen = 100;
        ...
        public static bool saveTest = false;
        ...
        public static byte[] ExecuteCommand(string command)
        {
            if (writeDataList.ContainsKey(command))
            {
                ...
                ExecuteOriginPointCommand(data, command, 120);
                return data;
            }
            return null;
        }
        ...
        public static void SaveConfig(string value, string key)
        {
            ...
            {
                ParseCommunicationCommand.WriteFileCommand(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss ： ") + ex.Message + "\r\n");
            }
        }

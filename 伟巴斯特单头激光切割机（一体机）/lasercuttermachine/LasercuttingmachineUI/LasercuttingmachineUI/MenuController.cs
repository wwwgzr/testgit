...
namespace LasercuttingmachineUI
{
    public class MenuController
    {
        ...
        public void CreateMaterialMenuPanel()
        {
            ...
            materialMenuButtons.Add(materialMenu.AddButton1("btn_SetOrigin1", "移 框", "移框"));
        ...
        public void ResetButtonLocation()
        {
            ...
            for (int i = 0; i < materialMenuButtons.Count; i++)
            {
                ...
                {
                    //btn_MoveFrame
                    if (materialMenuButtons[i].Name != "btn_SetOrigin1")
                    {
                        ...
                        try
                        {
                            ...
                            while (true)
                            {
                                ...
                                if (endstr == "Msg_End " || endstr == "Msg_OkPG")
                                {
                                    ...
                                    ParseCommunicationCommand.SaveLastFile(fileInfo.FullName);
                                    break;
                                }
                                if (ParseCommunicationCommand.usbIntPtr.ToInt32() == -1)
                                {
        ...
        public void btn_SetParam(MenuButton mbtn)
        {
            ...
            else
            {
                ...
                ps.addCutFileForm = openProject.userButtonPanel1.addFileForm;
        ...
        public void btn_SetOrigin(MenuButton mbtn)
        {
            ...
            else
            {
                ...
                mf.addCutFileForm = openProject.userButtonPanel1.addFileForm;
                frm_Project.isProject = false;
        ...
        public void btn_WorkMenu(MenuButton mbtn)
        {
            ...
            {
                //int x = mbtn.FindForm().Location.X + mbtn.Location.X + mbtn.Width / 2 - workMenu.Width / 2;
                //if (x < owner.SplitPanel.Left)
                //{
                //    x = 10;
                //}
                //workMenu.Location = new System.Drawing.Point(x, mbtn.FindForm().Location.Y + mbtn.Location.Y - workMenu.Height - 10);
                //workMenu.Show();
